...
//  diabet
//
//  Created by alexeyweb39@gmail.com on 08/12/2016, using AnimaApp.com, under MIT license.
...
public class APdiabetManager : NSObject {
    ...
    **/
    ...
    public func animaStoryboad() -> UIStoryboard {
        return UIStoryboard(name: "diabetUIKit", bundle:Bundle(for: type(of: self).self));
    }
